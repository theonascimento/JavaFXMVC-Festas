...
public class FXMLCadastrosClienteController implements Initializable {
    ...
    public void handleButtonInserir() throws IOException {
        ...
        boolean buttonConfirmarClicked = showFXMLCadastrosClienteDialog(cliente);
    ...
    public boolean showFXMLCadastrosClienteDialog(Cliente cliente) throws IOException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(FXMLCadastrosClienteDialogController.class.getResource("/javafestas/view/FXMLCadastrosClienteDialog.fxml"));
