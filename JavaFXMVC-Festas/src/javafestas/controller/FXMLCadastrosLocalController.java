...
public class FXMLCadastrosLocalController implements Initializable {
    ...
    @FXML
    public void handleButtonInserirLocal() throws IOException {
    ...
    @FXML
    public void handleButtonAlterarLocal() throws IOException {
    ...
    @FXML
    public void handleButtonRemoverLocal() throws IOException {
        Local local = tableViewLocal.getSelectionModel().getSelectedItem();
        if (local != null) {
